...
Original file is located at
    https://colab.research.google.com/drive/1INCbjRjnNzuoI9BrCWSemn7NrjDPICAK
"""

import sys
!{sys.executable} -m pip install streamlit joblib
...
def load_model(path='/content/model (1).pkl'):
    data = joblib.load(path)
    return data['pipeline'], data['features']

pipeline, features = load_model('/content/model (1).pkl')
